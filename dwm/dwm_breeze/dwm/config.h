...
static const int gappx              = 10;       /* размер гапсов работает при установке патча dwm-ru_gaps-6.2.diff */
static const int topbar             = 1;        /* 0 панель внизу */
static const char *fonts[]          = { "JetBrains Mono:size=10" };        /* шрифт бара*/
static const char dmenufont[]       = "JetBrains Mono:size=10";            /* шрифт dmenu*/
static const char col_gray1[]       = "#edeff1";        /* цвет col_gray1 */
static const char col_gray2[]       = "#1d344f";        /* цвет col_gray2 */
static const char col_gray3[]       = "#1d344f";        /* цвет col_gray3 */
static const char col_gray4[]       = "#edeff1";        /* цвет col_gray4 */
static const char col_cyan[]        = "#6ca8cf";        /* цвет col_cyan */
